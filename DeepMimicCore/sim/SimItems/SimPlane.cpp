...
void cSimPlane::Init(const std::shared_ptr<cWorldBase> &world,
                     const tParams &params)
{
    mType = eTypeStatic;
    mColShape = std::unique_ptr<btCollisionShape>(
        world->BuildPlaneShape(params.mNormal, params.mOrigin));
...
tVector cSimPlane::GetCoeffs() const { return GetSize(); }
