...
public:
    ...
    virtual void Constrain(const tVector &linear_factor,
...
protected:
    ...
    virtual void AddToWorld(const std::shared_ptr<cWorldBase> &world);
    ...
    virtual cWorldBase::tConstraintHandle GetConstraint(int c) const;
};