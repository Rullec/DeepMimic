...
public:
    ...
    virtual void Init(std::shared_ptr<cWorldBase> &world,
                      const std::shared_ptr<cSimObj> &parent_link,
                      const std::shared_ptr<cSimObj> &child_link,
    ...
    virtual void CalcWorldBaseRotation(tVector &out_axis, double &out_theta) const;
    virtual tQuaternion CalcWorldBaseRotation() const;
    ...
    virtual tVector CalcWorldBasePos() const;
    virtual tVector CalcWorldBasePos(const tVector &local_pos) const;
    virtual tVector CalcWorldBaseVel() const;
    virtual tVector CalcWorldBaseVel(const tVector &local_pos) const;
    virtual tVector CalcWorldBaseAngVel() const;
    ...
    virtual const tQuaternion &
    GetParentRot() const; // in parent link's coordinates
    virtual const tQuaternion &
    GetChildRot() const; // in child link's coordinates
    ...
    virtual const std::shared_ptr<btMultiBodyConstraint> &
    GetMultBodyCons() const;
...
protected:
    ...
    virtual void BuildConstraint(std::shared_ptr<cWorldBase> &world);
    virtual void BuildConstraintRevolute(std::shared_ptr<cWorldBase> &world);
    virtual void BuildConstraintPlanar(std::shared_ptr<cWorldBase> &world);
    virtual void BuildConstraintPrismatic(std::shared_ptr<cWorldBase> &world);
    virtual void BuildConstraintFixed(std::shared_ptr<cWorldBase> &world);
    virtual void BuildConstraintSpherical(std::shared_ptr<cWorldBase> &world);
