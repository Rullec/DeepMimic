...
cCtPDController::cCtPDController() : cCtController() { mGravity = gGravity; }
...
void cCtPDController::SetGravity(const tVector &gravity) { mGravity = gravity; }

std::string cCtPDController::GetName() const { return "ct_pd"; }

void cCtPDController::SetupPDControllers(const Json::Value &json,
...
void cCtPDController::BuildJointActionBounds(int joint_id,
...
void cCtPDController::BuildJointActionOffsetScale(
...
/**
 * \brief				convert PD target pose to action which is
 * truly used in training
 * \param				the ref of given PD target. It will be revised
 * in this function!
 *
...
void cCtPDController::ConvertActionToTargetPose(
...
void cCtPDController::ConvertTargetPoseToAction(
    int joint_id, Eigen::VectorXd &out_theta) const
{
#if defined(ENABLE_PD_SPHERE_AXIS)
    cKinTree::eJointType joint_type = GetJointType(joint_id);
...
const tVectorXd &cCtPDController::GetCurAction() { return mCurAction; }
...
void cCtPDController::CalcPDTarget(const Eigen::VectorXd &torque_,
