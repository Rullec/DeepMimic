...
void cExpPDController::Init(cSimCharacterBase *character,
...
void cExpPDController::UpdateControlForce(double time_step,
...
int cExpPDController::GetNumJoints() const { return mChar->GetNumJoints(); }

int cExpPDController::GetNumDof() const { return mChar->GetNumDof(); }

void cExpPDController::GetTargetTheta(int joint_id,
...
void cExpPDController::GetTargetVel(int joint_id,
...
void cExpPDController::CalcControlForces(double time_step,
                                         Eigen::VectorXd &out_tau)
{
