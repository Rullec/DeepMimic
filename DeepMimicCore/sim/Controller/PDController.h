...
public:
    ...
    static bool LoadParams(const std::string &file,
                           Eigen::MatrixXd &out_buffer);
    static bool LoadParams(const Json::Value &root,
                           Eigen::MatrixXd &out_buffer);
    ...
    virtual void Init(cSimCharacterBase *character, const tParams &params);
    virtual void Clear();
...
protected:
    ...
    virtual void CalcJointTauRevolute(double time_step,
                                      Eigen::VectorXd &out_joint_tau);
    virtual void CalcJointTauPlanar(double time_step,
                                    Eigen::VectorXd &out_joint_tau);
    virtual void CalcJointTauPrismatic(double time_step,
                                       Eigen::VectorXd &out_joint_tau);
    virtual void CalcJointTauFixed(double time_step,
                                   Eigen::VectorXd &out_joint_tau);
    virtual void CalcJointTauSpherical(double time_step,
                                       Eigen::VectorXd &out_joint_tau);
