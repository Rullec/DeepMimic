...
*/
tMatrixXd cCtPDGenController::GetDCtrlForceDAction()
{
 ...
 *      the accurate calculation needs the third order derivative w.r.t freedoms, 
 *      it will cost a lot, and we only calculate an approximate     
 * 
 *      For more details, please check the note "20210112 计算控制力u对状态x的导数"
*/
tMatrixXd cCtPDGenController::CalcDCtrlForceDx_Approx(double dt)
{
...
void cCtPDGenController::TestDCtrlForceDx_Approx()
{
    ...
    double dt = 1.6e-3;
    tMatrixXd ideal_dudx = CalcDCtrlForceDx_Approx(dt);
