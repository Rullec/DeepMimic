...
void cDeepMimicCharController::RecordState(Eigen::VectorXd& out_state)
{
	...
	// std::cout <<"record state in void cDeepMimicCharController::RecordState(Eigen::VectorXd& out_state) " << std::endl;
	// 设置一个NaN的(275, 1)的向量
	...
	// std::cout << "pose_offset and pose_size: " << pose_offset <<" " << pose_size << std::endl;
	// std::cout << "vel_offset and vel_size: " << vel_offset <<" " << vel_size << std::endl;
...
void cDeepMimicCharController::RecordGoal(Eigen::VectorXd& out_goal) const
{
	...
	// std::cout << "void cDeepMimicCharController::RecordGoal(Eigen::VectorXd& out_goal) const record goal 不会改变大小" << std::endl;
