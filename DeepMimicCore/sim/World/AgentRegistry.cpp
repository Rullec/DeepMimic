...
int cAgentRegistry::GetNumAgents() const { return mIDManager.GetNumUsed(); }

int cAgentRegistry::AddAgent(const std::shared_ptr<cCharController> &agent,
...
cSimCharacterBase *cAgentRegistry::GetChar(int id) const { return mChars[id]; }
