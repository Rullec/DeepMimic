...
void cDrawUtil::EnableDraw(bool enable) { gEnableDraw = enable; }

bool cDrawUtil::EnableDraw() { return gEnableDraw; }
...
#ifdef __APPLE__
    printf(
        "[error] cDrawUtil::CheckDrawContextInit invalid in OS X platform\n");
    exit(1);
    return false;
#else
...
void cDrawUtil::DrawRect(const tVector &pos, const tVector &size,
                         eDrawMode draw_mode)
{
    tVector a =
...
void cDrawUtil::DrawBox(const tVector &pos, const tVector &size,
                        const tVector &tex_coord_min,
                        const tVector &tex_coord_max, eDrawMode draw_mode)
{
...
void cDrawUtil::DrawBoxSolid(const tVector &pos, const tVector &size,
                             const tVector &tex_coord_min,
                             const tVector &tex_coord_max)
{
    ...
    const float coord_data[coord_len] = {
        static_cast<float>(tex_coord_min[0]),
        static_cast<float>(tex_coord_min[2]), // top
        static_cast<float>(tex_coord_max[0]),
        static_cast<float>(tex_coord_min[2]),
        static_cast<float>(tex_coord_max[0]),
        static_cast<float>(tex_coord_max[2]),
        static_cast<float>(tex_coord_max[0]),
        static_cast<float>(tex_coord_max[2]),
        static_cast<float>(tex_coord_min[0]),
        static_cast<float>(tex_coord_max[2]),
        ...
        static_cast<float>(tex_coord_max[0]),
        static_cast<float>(tex_coord_min[2]), // bottom
        static_cast<float>(tex_coord_max[0]),
        static_cast<float>(tex_coord_max[2]),
        static_cast<float>(tex_coord_min[0]),
        static_cast<float>(tex_coord_max[2]),
        ...
        static_cast<float>(tex_coord_min[0]),
        static_cast<float>(tex_coord_min[1]), // front
        static_cast<float>(tex_coord_max[0]),
        static_cast<float>(tex_coord_min[1]),
        static_cast<float>(tex_coord_max[0]),
        static_cast<float>(tex_coord_max[1]),
        static_cast<float>(tex_coord_max[0]),
        static_cast<float>(tex_coord_max[1]),
        static_cast<float>(tex_coord_min[0]),
        static_cast<float>(tex_coord_max[1]),
        ...
        static_cast<float>(tex_coord_min[0]),
        static_cast<float>(tex_coord_min[1]), // back
        static_cast<float>(tex_coord_max[0]),
        static_cast<float>(tex_coord_min[1]),
        static_cast<float>(tex_coord_max[0]),
        static_cast<float>(tex_coord_max[1]),
        ...
        static_cast<float>(tex_coord_max[2]),
        static_cast<float>(tex_coord_min[1]), // left
        static_cast<float>(tex_coord_max[2]),
        static_cast<float>(tex_coord_max[1]),
        static_cast<float>(tex_coord_min[2]),
        static_cast<float>(tex_coord_max[1]),
        ...
        static_cast<float>(tex_coord_max[2]),
        static_cast<float>(tex_coord_min[1]), // right
        static_cast<float>(tex_coord_max[2]),
        static_cast<float>(tex_coord_max[1]),
        static_cast<float>(tex_coord_min[2]),
        static_cast<float>(tex_coord_max[1]),
    ...
    gBoxSolidMesh->LoadVBuffer(attr_info.mAttribNumber,
                               sizeof(float) * coord_len, (GLubyte *)coord_data,
                               0, 1, &attr_info);
...
void cDrawUtil::DrawTriangle(const tVector &pos, double side_len,
                             eDrawMode draw_mode)
{
...
void cDrawUtil::DrawQuad(const tVector &a, const tVector &b, const tVector &c,
                         const tVector &d, eDrawMode draw_mode)
{
...
void cDrawUtil::DrawQuad(const tVector &a, const tVector &b, const tVector &c,
                         const tVector &d, const tVector &coord_a,
                         const tVector &coord_b, const tVector &coord_c,
                         const tVector &coord_d, eDrawMode draw_mode)
{
    ...
    const float pos_data[pos_len] = {
        ...
        static_cast<float>(a[2]), static_cast<float>(b[0]),
        static_cast<float>(b[1]), static_cast<float>(b[2]),
        static_cast<float>(c[0]), static_cast<float>(c[1]),
        static_cast<float>(c[2]), static_cast<float>(d[0]),
        static_cast<float>(d[1]), static_cast<float>(d[2])};

    const float norm_data[norm_len] = {
        static_cast<float>(normal[0]), static_cast<float>(normal[1]),
        static_cast<float>(normal[2]), static_cast<float>(normal[0]),
        static_cast<float>(normal[1]), static_cast<float>(normal[2]),
        static_cast<float>(normal[0]), static_cast<float>(normal[1]),
        static_cast<float>(normal[2]), static_cast<float>(normal[0]),
        static_cast<float>(normal[1]), static_cast<float>(normal[2])};
    ...
    gQuadMesh->LoadVBuffer(attr_info.mAttribNumber, sizeof(float) * pos_len,
                           (GLubyte *)pos_data, 0, 1, &attr_info);
    ...
    gQuadMesh->LoadVBuffer(attr_info.mAttribNumber, sizeof(float) * norm_len,
                           (GLubyte *)norm_data, 0, 1, &attr_info);
    ...
    attr_info.mDataStride = 0;
    attr_info.mNumComp = cMeshUtil::gCoordDim;
    gQuadMesh->LoadVBuffer(attr_info.mAttribNumber, sizeof(float) * coord_len,
                           (GLubyte *)coord_data, 0, 1, &attr_info);
...
void cDrawUtil::DrawDisk(const tVector &pos, const tVector &r,
                         eDrawMode draw_mode)
{
...
void cDrawUtil::DrawLine(const tVector &a, const tVector &b)
{
    ...
    attr_info.mDataStride = 0;
    attr_info.mNumComp = cMeshUtil::gPosDim;
    gLineMesh->LoadVBuffer(attr_info.mAttribNumber, sizeof(float) * pos_len,
                           (GLubyte *)pos_data, 0, 1, &attr_info);
...
void cDrawUtil::DrawStrip(const tVector &a, const tVector &b, double width,
                          eDrawMode draw_mode)
{
    tVector delta = b - a;
...
void cDrawUtil::DrawHemisphere(double r, eDrawMode draw_mode)
{
    ...
    if (draw_mode == eDrawSolid)
        ...
        {
            gSphereWireSimpleMesh->Draw(GL_LINES, 0,
                                        ((gNumStacks / 2) * 4 + gNumSlice) * 2);
        }
    else
        {
            assert(false); // unsupported draw mode
...
void cDrawUtil::DrawPlane(const tVector &coeffs, double size,
                          eDrawMode draw_mode)
{
...
void cDrawUtil::DrawArrow2D(const tVector &start, const tVector &end,
                            double head_size)
{
...
void cDrawUtil::DrawArrow3D(const tVector &start, const tVector &end,
                            double head_size)
{
    tVector dir = tVector(0, 1, 0, 0);
    double dir_len = 0;
...
void cDrawUtil::DrawGrid2D(const tVector &origin, const tVector &size,
                           double spacing, double line_width)
{
    double w = size[0];
    double h = size[1];
...
void cDrawUtil::DrawRuler2D(const tVector &origin, const tVector &size,
                            const tVector &col, double line_width,
                            double marker_spacing, double marker_h,
    ...
    if (line_width > 0)
        {
            ...
            cDrawUtil::DrawLine(tVector(min_x, max_y, 0, 0),
                                tVector(max_x, max_y, 0, 0));
        }
    ...
    if (marker_line_width > 0)
        {
            ...
            for (double x = min_x - std::fmod(min_x, marker_spacing); x < max_x;
                 x += marker_spacing)
                {
...
void cDrawUtil::DrawTexQuad(const cTextureDesc &tex, const tVector &pos,
                            const tVector &size)
{
    ...
    DrawQuad(tVector(pos[0] - 0.5 * size[0], pos[1] - 0.5 * size[1], pos[2], 0),
             ...
             tVector(pos[0] + 0.5 * size[0], pos[1] + 0.5 * size[1], pos[2], 0),
             tVector(pos[0] - 0.5 * size[0], pos[1] + 0.5 * size[1], pos[2], 0),
             tVector(0, 0, 0, 0), tVector(1, 0, 0, 0), tVector(1, 1, 0, 0),
             tVector(0, 1, 0, 0), eDrawSolid);
    tex.UnbindTex(GL_TEXTURE0);
}

void cDrawUtil::CopyTexture(const cTextureDesc &src_tex,
                            const cTextureDesc &dst_tex)
{
...
void cDrawUtil::CopyTexture(const cTextureDesc &src_tex,
                            const cTextureDesc &dst_tex,
                            const tVector &dst_min_coord,
                            const tVector &dst_max_coord)
{
    dst_tex.BindBuffer();
...
void cDrawUtil::LoadIdentityView() { gMatStackView.SetIdentity(); }

void cDrawUtil::LoadIdentityProj() { gMatStackProj.SetIdentity(); }

void cDrawUtil::PushMatrixView() { gMatStackView.Push(); }

void cDrawUtil::PushMatrixProj() { gMatStackProj.Push(); }

void cDrawUtil::PopMatrixView() { gMatStackView.Pop(); }

void cDrawUtil::PopMatrixProj() { gMatStackProj.Pop(); }

void cDrawUtil::BindDefaultProg() { gDefaultProg.Bind(); }

void cDrawUtil::UnbindDefaultProg() { gDefaultProg.Unbind(); }

void cDrawUtil::BindCopyMeshProg() { gCopyMeshProg.Bind(); }

void cDrawUtil::UnbindCopyMeshProg() { gCopyMeshProg.Unbind(); }
            ...
            if (curr_shader->HasUniform(cShader::eUniformModelViewMatrix))
                {
                    ...
                    curr_shader->SetUniformMat(cShader::eUniformModelViewMatrix,
                                               view_mat);
                }
            ...
            if (curr_shader->HasUniform(cShader::eUniformProjectionMatrix))
                {
                    ...
                    curr_shader->SetUniformMat(
                        cShader::eUniformProjectionMatrix, proj_mat);
                }
...
void cDrawUtil::Finish() { glFinish(); }
...
void cDrawUtil::BuildMeshes()
{
    ...
    cMeshUtil::BuildSphereWireSimpleMesh(gNumStacks, gNumSlice,
                                         gSphereWireSimpleMesh);
...
void cDrawUtil::Scale(const tVector &scale) { gMatStackView.Scale(scale); }
...
void cDrawUtil::SetColor(const tVector &col) { gColor = col; }

void cDrawUtil::SetLineWidth(double w) { glLineWidth(static_cast<float>(w)); }
...
{
    {
        gDefaultProg.BuildShader("data/shaders/Mesh_VS.glsl",
                                 "data/shaders/VertColor_PS.glsl");
    }

    {
        gCopyProg.BuildShader("data/shaders/FullScreenQuad_VS.glsl",
                              "data/shaders/DownSample_PS.glsl");
    }

    {
        gCopyMeshProg.BuildShader("data/shaders/Mesh_VS.glsl",
                                  "data/shaders/DownSample_PS.glsl");
    }
}
