...
public:
    ...
    static void BuildDrawMesh(const float *pos_data, int pos_size,
                              const int *idx_data, int idx_size,
                              cDrawMesh *out_mesh);
    static void BuildDrawMesh(const float *pos_data, int pos_size,
                              const float *norm_data, int norm_size,
                              const float *coord_data, int coord_size,
                              const int *idx_data, int idx_size,
                              cDrawMesh *out_mesh);
    ...
    static void ExpandFaces(const cDrawMesh &mesh,
                            std::shared_ptr<cDrawMesh> &out_mesh);
    static void RayTest(const tVector &start, const tVector &end,
                        const cDrawMesh &mesh,
    ...
    static void BuildSphereMesh(int stacks, int slices,
                                std::unique_ptr<cDrawMesh> &out_mesh);
    static void BuildSphereWireSimpleMesh(int stacks, int slices,
                                          std::unique_ptr<cDrawMesh> &out_mesh);
    ...
    static void BuildCylinderWireSimple(int slices,
                                        std::unique_ptr<cDrawMesh> &out_mesh);
    static void BuildCone(int slices, std::unique_ptr<cDrawMesh> &out_mesh);
    static void BuildConeWireSimple(int slices,
                                    std::unique_ptr<cDrawMesh> &out_mesh);
    static void BuildCapsuleMesh(int stacks, int slices,
                                 std::unique_ptr<cDrawMesh> &out_mesh);
    static void
...
protected:
    static bool RayIntersectTriangle(const tVector &start, const tVector &end,
                                     const tVector &v0, const tVector &v1,
