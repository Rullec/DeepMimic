...
public:
    ...
    virtual void Clear();
    virtual bool BuildShader(const std::string &vs_filename,
                             const std::string &ps_filename);
    virtual void GetAttributeHandle(GLuint &attribute_handle,
                                    const std::string &attribute_name);
    virtual void GetUniformHandle(GLuint &uniform_handle,
