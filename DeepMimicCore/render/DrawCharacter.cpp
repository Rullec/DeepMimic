...
void cDrawCharacter::Draw(const cCharacter &character, double link_width,
...
void cDrawCharacter::DrawPose(const cCharacter &character,
...
void cDrawCharacter::DrawShape(const cKinTree::tDrawShapeDef &def,
                               const tMatrix &parent_world_trans,
                               const tVector &fill_tint,
                               const tVector &line_col)
{
    cShape::eShape shape =
        static_cast<cShape::eShape>((int)def[cKinTree::eDrawShapeShape]);
    switch (shape)
    {
...
void cDrawCharacter::DrawHeading(const cCharacter &character, double arrow_size,
                                 const tVector &arrow_col,
...
void cDrawCharacter::DrawShapeMesh(const cKinTree::tDrawShapeDef &def,
                                   const tMatrix &parent_world_trans,
                                   cDrawMesh &mesh, const tVector &fill_tint)
{
    ...
    tVector scale = tVector(def[cKinTree::eDrawShapeParam0],
                            def[cKinTree::eDrawShapeParam1],
                            def[cKinTree::eDrawShapeParam2], 0);
...
void cDrawCharacter::DrawCharShapes(const cCharacter &character,
                                    const tVector &fill_tint,
                                    const tVector &line_col)
{
    ...
    // std::cout <<"------------draw char shapes------------" << num_shapes <<
    // std::endl;;
    for (int i = 0; i < num_shapes; ++i)
    {
        ...
        if (mesh_id != gInvalidIdx)
        {
            ...
            cDrawCharacter::DrawShapeMesh(curr_def, parent_world_trans, *mesh,
                                          fill_tint);
        }
        else
        {
...
void cDrawCharacter::DrawPoseCharShapes(const cCharacter &character,
                                        const Eigen::VectorXd &pose,
                                        const tVector &fill_tint,
                                        const tVector &line_col)
{
    ...
    for (int i = 0; i < num_shapes; ++i)
    {
        ...
        int parent_joint = cKinTree::GetDrawShapeParentJoint(curr_def);
        tMatrix parent_world_trans =
            cKinTree::JointWorldTrans(joint_mat, pose, parent_joint);
...
void cDrawCharacter::DrawShapeBox(const cKinTree::tDrawShapeDef &def,
                                  const tMatrix &parent_world_trans,
                                  const tVector &fill_tint,
                                  const tVector &line_col)
{
    ...
    tVector attach_pt = cKinTree::GetDrawShapeAttachPt(def);
    tVector col = cKinTree::GetDrawShapeColor(def);
    tVector size = tVector(def[cKinTree::eDrawShapeParam0],
                           def[cKinTree::eDrawShapeParam1],
                           def[cKinTree::eDrawShapeParam2], 0);
    col = col.cwiseProduct(fill_tint);
...
void cDrawCharacter::DrawShapeCapsule(const cKinTree::tDrawShapeDef &def,
                                      const tMatrix &parent_world_trans,
                                      const tVector &fill_tint,
                                      const tVector &line_col)
{
    ...
    tVector col = cKinTree::GetDrawShapeColor(def);
    tVector size = tVector(def[cKinTree::eDrawShapeParam0],
                           def[cKinTree::eDrawShapeParam1], 0, 0);
    col = col.cwiseProduct(fill_tint);
...
void cDrawCharacter::DrawShapeSphere(const cKinTree::tDrawShapeDef &def,
                                     const tMatrix &parent_world_trans,
                                     const tVector &fill_tint,
                                     const tVector &line_col)
{
...
void cDrawCharacter::DrawShapeCylinder(const cKinTree::tDrawShapeDef &def,
                                       const tMatrix &parent_world_trans,
                                       const tVector &fill_tint,
                                       const tVector &line_col)
{
