...
public:
    ...
    static void DrawRect(const tVector &pos, const tVector &size,
    ...
    static void DrawBox(const tVector &pos, const tVector &size,
                        ...
                        eDrawMode draw_mode = eDrawSolid);
    static void DrawTriangle(const tVector &pos, double side_len,
                             eDrawMode draw_mode = eDrawSolid);
    static void DrawQuad(const tVector &a, const tVector &b, const tVector &c,
                         const tVector &d, eDrawMode draw_mode = eDrawSolid);
    static void DrawQuad(const tVector &a, const tVector &b, const tVector &c,
                         const tVector &d, const tVector &coord_a,
                         const tVector &coord_b, const tVector &coord_c,
                         const tVector &coord_d,
                         eDrawMode draw_mode = eDrawSolid);
    static void DrawDisk(const tVector &pos, double r,
                         eDrawMode draw_mode = eDrawSolid);
    static void DrawDisk(const tVector &pos, const tVector &r,
                         eDrawMode draw_mode = eDrawSolid);
    ...
    static void DrawStrip(const tVector &a, const tVector &b, double width,
                          eDrawMode draw_mode = eDrawSolid);
    static void DrawCross(const tVector &pos, double size);
    static void DrawPlane(const tVector &coeffs, double size,
                          eDrawMode draw_mode = eDrawSolid);
    ...
    static void DrawCylinder(double r, double h,
                             eDrawMode draw_mode = eDrawSolid);
    ...
    static void DrawCapsule(double r, double h,
                            eDrawMode draw_mode = eDrawSolid);

    static void DrawArrow2D(const tVector &start, const tVector &end,
                            double head_size);
    static void DrawArrow3D(const tVector &start, const tVector &end,
                            double head_size);
    static void DrawGrid2D(const tVector &origin, const tVector &size,
    ...
    static void DrawSemiCircle(const tVector &pos, double r, int slices,
    ...
    static void DrawTexQuad(const cTextureDesc &tex, const tVector &pos,
                            const tVector &size);
...
protected:
    ...
    static void DrawBoxSolid(const tVector &pos, const tVector &size,
                             const tVector &tex_coord_min,
                             const tVector &tex_coord_max);
    static void DrawBoxWire(const tVector &pos, const tVector &size);

    static void DrawCylinderSolidWire(double r, double h,
                                      eDrawMode draw_mode = eDrawSolid);
    static void DrawCylinderWireSimple(double r, double h);
    static void DrawTubeSolidWire(double r, double h,
                                  eDrawMode draw_mode = eDrawSolid);
    static void DrawConeSolidWire(double r, double h,
                                  eDrawMode draw_mode = eDrawSolid);
