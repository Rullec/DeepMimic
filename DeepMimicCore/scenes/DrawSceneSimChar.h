...
protected:
    ...
    virtual void AddCharTrace(const std::shared_ptr<cSimCharacterBase> &character,
    ...
    virtual void RayTest(const tVector &start, const tVector &end,
                         cFeaWorld::tRayTestResult &out_result);
    virtual bool ObjectSelected() const;
    virtual void HandleRayTest(const cFeaWorld::tRayTestResult &result);
    ...
    virtual void
    DrawCharacter(const std::shared_ptr<cSimCharacterBase> &character) const;
