...
int cDrawRLScene::GetNumAgents() const { return GetRLScene()->GetNumAgents(); }
...
void cDrawRLScene::RecordContactInfo(int agent_id,
...
void cDrawRLScene::BuildStateOffsetScale(int agent_id,
...
void cDrawRLScene::BuildGoalOffsetScale(int agent_id,
                                        Eigen::VectorXd &out_offset,
                                        Eigen::VectorXd &out_scale) const
{
...
void cDrawRLScene::BuildActionOffsetScale(int agent_id,
                                          Eigen::VectorXd &out_offset,
                                          Eigen::VectorXd &out_scale) const
{
...
void cDrawRLScene::BuildActionBounds(int agent_id, Eigen::VectorXd &out_min,
                                     Eigen::VectorXd &out_max) const
{
    GetRLScene()->BuildActionBounds(agent_id, out_min, out_max);
}

void cDrawRLScene::BuildStateNormGroups(int agent_id,
                                        Eigen::VectorXi &out_groups) const
{
    GetRLScene()->BuildStateNormGroups(agent_id, out_groups);
}

void cDrawRLScene::BuildGoalNormGroups(int agent_id,
                                       Eigen::VectorXi &out_groups) const
{
...
bool cDrawRLScene::IsEpisodeEnd() const { return GetRLScene()->IsEpisodeEnd(); }
...
void cDrawRLScene::SetMode(eMode mode) { return GetRLScene()->SetMode(mode); }
...
std::string cDrawRLScene::GetName() const { return GetRLScene()->GetName(); }
