...
std::string cDrawSceneKinChar::GetName() const { return mScene->GetName(); }

void cDrawSceneKinChar::BuildScene(
    std::shared_ptr<cSceneKinChar> &out_scene) const
{
...
tVector cDrawSceneKinChar::GetDefaultCamFocus() const { return gCamFocus0; }
